...
public record ChunkCoordinate(int x, int z) implements Comparable<ChunkCoordinate> {
    ...
    @Override
    public int compareTo(final ChunkCoordinate o) { return this.x == o.x ? Integer.compare(this.z, o.z) : Integer.compare(this.x, o.x); }
    ...
    @Override
    public String toString() { return String.format("%d, %d", x, z); }
}
